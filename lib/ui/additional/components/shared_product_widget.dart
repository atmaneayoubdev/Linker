...
import 'package:linker/ui/common/market_product_item_widget.dart';
...
class SharedProductWidget extends StatefulWidget {
  const SharedProductWidget({
    Key? key,
    required this.post,
  ...
  @override
  State<SharedProductWidget> createState() => _SharedProductWidgetState();
}

class _SharedProductWidgetState extends State<SharedProductWidget> {
        ...
        child: Column(
          children: [
            ...
            MarketProductItemWidget(
              canNavigat: false,
              isFav: true,
              product: widget.post.postTypeInfoProduct!,
              from: "post",
            ),
            12.verticalSpace,
